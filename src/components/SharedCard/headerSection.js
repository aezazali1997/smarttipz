  ...
  return (
    <div className="flex w-full py-2 px-2 justify-between space-x-2">
      <div className="flex space-x-2">
        <img
          src={Share?.User?.picture || 'https://logos-world.net/wp-content/uploads/2020/12/Lays-Logo.png'}
        ...
        <div className="flex flex-col w-full">
          ...
          <p className="text-sm text-gray-500 mt-1">
            ...
            {moment(Share?.createdAt).format('D MMM YYYY')} , {moment(Share?.createdAt).format('H:mm')}
          </p>
        </div>
      </div>
    </div>
