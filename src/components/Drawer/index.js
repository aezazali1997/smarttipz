      ...
      sidebar={
        <nav
          ...
          <div className=" lg:flex flex-col h-full pt-2 overflow-y-auto">
            ...
            {Routes &&
              Routes.map(({ name, path, icon, badge }, index) => (
            ...
            <div ref={DropdownRef} className="inline-block relative space-y-1">
              <button
                ...
                className={`flex items-center justify-between py-2 px-3 rounded-lg w-52 font-medium sidebar-item cursor-pointer
      ...
      <nav
        ...
        <h1 className="text-2xl font-bold font-sans">
          {asPath === '/dashboard/setting'
            ...
            ? 'Profile'
            : asPath === '/dashboard/videos'
            ? 'Videos'
            : asPath === '/dashboard/messages'
            ? 'Messages'
            : 'News Feed'}
        </h1>
        <span className="relative px-6 inline-block cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" width="19.99" height="23.625" viewBox="0 0 19.99 23.625">
            <path
              ...
              d="M15.62,27a2.364,2.364,0,0,0,2.352-2.362h-4.7A2.364,2.364,0,0,0,15.62,27Zm7.643-7.087v-6.5a7.656,7.656,0,0,0-5.88-7.442V5.147a1.764,1.764,0,1,0-3.528,0v.827a7.656,7.656,0,0,0-5.88,7.442v6.5L5.625,22.275v1.181h19.99V22.275Z"
