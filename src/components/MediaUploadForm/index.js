...
const Index = ({ formik, thumbnailUrl, _OnThumbnailClick, urls, _DeleteImg, ChangeAgreement,
  ...
  _HandleChangePostOnNewsfeed, checkPostOnFeed, videoType
}) => {
          ...
          <>
            <div className="flex flex-col w-full py-2 space-y-3 h-96 overflow-y-auto px-2">
              ...
              <div className="flex flex-col w-full">
                ...
                }
                {
                  ...
                  <>
                    ...
                    }
                    {
                      videoType === 'SmartTipz' ? (
                        <>
                          <div className={`floating-input relative ${formik.touched.videoCost && formik.errors.videoCost ? 'mb-1' : 'mb-4'}`}>
                            <select
                              type={'select'}
                              id={'videoCost'}
                              name={'videoCost'}
                ...
                <div className={`floating-input relative ${formik.touched.language && formik.errors.language ? 'mb-1' : 'mb-4'}`}>
                  <select
                    type={'select'}
                    id={'language'}
                    name={'language'}
