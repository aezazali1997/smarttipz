    ...
    return (
        <>
            <header className="flex flex-col w-full p-5 pb-2">
                <div onClick={() => goBackToUserList(selected?.id)} className='lg:hidden flex bg-white items-center w-full space-x-5 mb-2'>
                ...
                <div className='hidden lg:flex items-center space-x-3 mb-2'>
                    <img className="inline object-cover w-12 h-10 rounded-full"
                        src={selected?.picture || "https://images.pexels.com/photos/2589653/pexels-photo-2589653.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"} alt="Profile image" />
                    <div className="flex flex-col w-full">
