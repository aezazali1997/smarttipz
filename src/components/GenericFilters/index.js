      ...
      <div className="flex flex-col w-full bg-white rounded-lg shadow py-4 px-3">
        {Data.map(({ icon, name }, index) => (
          <div
            ...
            className={`flex space-x-3 px-2 py-2 w-full items-center rounded-md ${
              activeGenericFilter === name && 'bg-gray-100'
            ...
            <div className=" bg-gray-300 rounded-full w-10 h-10 p-2 flex items-center justify-center">
              <FontAwesomeIcon icon={icon} className={`text-xl ${activeGenericFilter === name && 'text'}`} />
            </div>
        ...
        <div className="flex items-center justify-center space-x-3 mt-1">
          <div className=" bg-gray-300 rounded-full p-2 w-11 h-10 flex items-center justify-center">
            <FontAwesomeIcon icon={faLayerGroup} className={`text-xl ${category && 'text'}`} />
          </div>
          <div className={`relative z-0 w-full`}>
            ...
            <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none pl-1">
              <svg
