    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button
            type="button"
            className={`w-full inline-flex justify-center rounded-md border-none px-4 py-2 text-base font-medium text-white focus:outline-none sm:ml-3 sm:w-auto sm:text-sm ${hasBankDetails && amount > 0 && error==='' ? 'btn' : 'btn-disable'} `}
            childrens={'Proceed'}
            loading={loading}
