...
const UseFetchVideo = () => {
    ...
    return {
        _HandleSharePost, _HandleChangeCaption, _OpenShareModal, HandleLikePost, _HandleGotoVideoDetails,
        _HandleDeleteVideo, _HandleCatalogue, _ChangeFilter, _CloseShareModal, filterdVideos, Videos, filter,
        loading, catalogueCount, showShareModal, isSharing, shareData, shareCaption, setShareCaption
    }
}
