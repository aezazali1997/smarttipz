...
import { Button, InputField, Footer, PhoneInput } from 'src/components';
import { UseFetchSignup } from 'src/hooks';
import { CloseEye, Email, OpenEye, PhoneSVG, User, GlobeSVG } from 'src/assets/SVGs';


const Signup = () => {

	const { loading, showPassword, formik, agree, accountType, phone, _HandlePhone,
		setShowPassword, toggleModal, _SelectAccount } = UseFetchSignup();
