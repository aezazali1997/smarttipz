    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row justify-center items-center w-full mt-5 ">
                <div className="flex flex-col max-w-xs sm:max-w-sm border rounded-lg py-4 shadow-lg bg-white">
                            ...
                            <div id="pointer" className="p-2 pt-0 space-y-2">
                                ...
                                <div>
                                    <span className="flex items-center">
                                        ...
                                        &nbsp;
                                        <h1 className="text-sm font-normal text-white">{phone}</h1>
                                    </span>
                                    <span className="flex items-center">
                                        ...
                                        &nbsp;
                                        <h1 className="text-sm font-normal text-white">{email}</h1>
                                    </span>
                                    <span className="flex items-center">
                                        <svg className="w-4 h-4 text-gray-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clipRule="evenodd" /></svg>
                                        &nbsp;
                                        <h1 className="text-sm font-normal text-white">{website}</h1>
                                    </span>
                                </div>
                            </div>
                            <div id="pointer1"></div>
