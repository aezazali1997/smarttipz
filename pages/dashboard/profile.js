...
import { Card, PopupBusinessCard, ProfileCard, Rating, TestimonialCard, TestimonialForm } from 'components';
import cookie from 'js-cookie';
import { getInputClasses } from 'helpers';

const Profile = ({ profile }) => {

	const { handleShowBusinessCard, showBusinessCard, followed, followers, businessCard, formik } = UseFetchProfile(profile);
		...
		<div className="flex flex-col h-full w-full p-3 sm:p-5">
			...
			{accountType === 'Business' && (
				<div className="flex flex-col w-full px-2  mt-8">
					...
					<div className="flex w-full mt-6 justify-center lg:justify-start">
						<TestimonialForm formik={formik} getInputClasses={getInputClasses} />
					</div>
