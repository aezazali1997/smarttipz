...
import { Card, ProfileCard, Rating, Spinner, TestimonialCard } from '../../../components';
...
const UserProfile = () => {
    ...
    useEffect(() => {
        if (username) {
            ...
            if (accountType === 'Business') {
                axiosInstance.getSpecificBusinessCard().then(({ data: { error, data, message } }) => {
    ...
    const { name, about, rating, views, picture, phone, email, accountType } = personalInfo;
                    ...
                    (
                        <>
                            <div className="flex px-2 py-1">
                                ...
                                {picture ?
                                    <img src={picture} alt="profile" className="rounded-2xl w-28 h-36 object-cover" />
                                    :
                                    <img
