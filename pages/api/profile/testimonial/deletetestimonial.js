...
const handler = async (req, res) => {
  if (req.method === 'POST') {
    const validateDeletetestimonial = (data) => {
    ...
    const { error } = validateDeletetestimonial(req.body);
    ...
    try {
      ...
      const testimonial = await Testimonial.findOne({ where: { id: req.body.testimonialId } });
